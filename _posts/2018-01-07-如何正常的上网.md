...
对应于 TCP RST 机制的故障点，如刚才所述，在12跳（202.112.61.214）背后，这也是实现 IP 封锁，进行 IP 丢包的实际位置。而进行 DNS 污染抢答的故障点则在第9跳处，明显更靠前，也许说明地方级的骨干路由就存在 DNS 污染的局部故障。同时注意到第8，9跳处，路由选择格外丰富，也许是需要额外处理些什么，所以加了些路由做做负载均衡。
...
TCP RST 有什么调整余地和绕过办法呢，如果服务端自己能控制，当然随便魔改下，强行两边无视 RST 包，或是像某些方案一样，用一些独特的发包顺序或发包内容，有可能触及网络故障点的知识盲区，从而顺利连接。当然这些方案都比较脆弱，可能只是帮助人家抱修 bug 呢。
